...
void PreDraw(){
    ...
    lightPos.x = sinf(glm::radians(angle))*5.0f;

    glm::vec3 cameraPos;
    cameraPos.x = g_camera.GetEyePos().x;
    cameraPos.y = g_camera.GetEyePos().y;
    cameraPos.z = g_camera.GetEyePos().z;
    ...
    // GLint u_lightPos = glGetUniformLocation(gGraphicsPipelineLightShader, "lightPos");
